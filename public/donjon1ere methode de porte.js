...
//Ouvrir porte
imDoor.ImA1.addEventListener("click", () =>
    openDoor("A1", ImA1, "ImOpenA1", "D1"),
);
imDoor.ImA2.addEventListener("click", () =>
    openDoor("A2", ImA2, "ImOpenA2", "D2"),
);
imDoor.ImA3.addEventListener("click", () =>
    openDoor("A3", ImA3, "ImOpenA3", "D3"),
);
//Entrez porte
