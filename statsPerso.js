...
function update() {
    ...
    document.getElementById('degatsArmeG').textContent = `Arme gauche : ${stats.LeftHand}`
    document.getElementById('degatsArmeD').textContent = `Arme droite : ${stats.RightHand}`
    ...
    document.getElementById('mp').textContent = `Points de mana : ${statPerso.MP}/${statPerso.MP}`
}
...
function addStat(stat) {
    if (statPerso.Point > 1) {
        ...
        btn.forEach(element => { element.style.display = "none" })
        statPerso.Point--;
        statPerso[stat]++;
        update();
    }
...
elements.armureEnFer.addEventListener('click', () => takeObject('armureEnFer', "Chest", "baseChest"))  
elements.casqueEnCuir.addEventListener('click', () => takeObject('casqueEnCuir', "Head", "baseHead"))
elements.anneauForce.addEventListener('click', () => takeObject('anneauForce', "Ring", "baseRing"))
elements.anneauDexterite.addEventListener('click', () => takeObject('anneauDexterite', "Ring", "baseRing"))
